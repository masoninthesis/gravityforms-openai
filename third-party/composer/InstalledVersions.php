 ...
 */
namespace GWiz_GF_OpenAI\Dependencies\Composer;

use GWiz_GF_OpenAI\Dependencies\Composer\Autoload\ClassLoader;
use GWiz_GF_OpenAI\Dependencies\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('GWiz_GF_OpenAI\\Dependencies\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
